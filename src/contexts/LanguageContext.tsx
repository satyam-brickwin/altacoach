...
const translations: Record<SupportedLanguage, Record<string, string>> = {
  en: {
    ...
    // resetPassword: "Reset Password",
    // settings: "Settings",
    updateYourPasswordRegularly: "Update your password regularly to maintain account security",
    ...
    minimumCharacters: "Minimum 8 characters long",
    uppercaseRequired: "At least one uppercase letter (A-Z)",
    numberRequired: "At least one number (0-9)",
    specialCharRequired: "At least one special character (!@#$%^&*)",
  ...
  fr: {
    ...
    Top3MostAskedQuestions: 'Top 3 Questions les Plus Posées',
    Asked: 'Posées',
    Last: 'Dernière',
    pricing: 'Tarifs',
    contact: 'Contact',
    ...
    altamediacontent: 'altamedia Contenu',
    ...
    // resetPassword: "Réinitialiser le Mot de Passe",
    // settings: "Paramètres",
    updateYourPasswordRegularly: "Mettez à jour votre mot de passe régulièrement pour maintenir la sécurité du compte",
    ...
    passwordNotStrongEnough: "Le mot de passe n'est pas assez fort",
    ...
    uppercaseRequired: "Au moins une lettre majuscule (A-Z)",
    numberRequired: "Au moins un chiffre (0-9)",
    specialCharRequired: "Au moins un caractère spécial (!@#$%^&*)",
    passwordExample: "Exemple",
  },
  de: {
    welcome: 'Willkommen',
    ...
    // resetPassword: "Passwort zurücksetzen",
    // settings: "Einstellungen",
    updateYourPasswordRegularly: "Aktualisieren Sie Ihr Passwort regelmäßig zur Aufrechterhaltung der Kontosicherheit",
    ...
    failedToUpdatePassword: "Passwortaktualisierung fehlgeschlagen",
    ...
    specialCharRequired: "Mindestens ein Sonderzeichen (!@#$%^&*)",
    passwordExample: "Beispiel",
  },
  it: {
    welcome: 'Benvenuto',
    ...
    updateYourPasswordRegularly: "Aggiorna regolarmente la tua password per mantenere la sicurezza dell'account",
    ...
    passwordNotStrongEnough: "La password non è abbastanza forte",
    ...
    minimumCharacters: "Minimo 8 caratteri",
    uppercaseRequired: "Almeno una lettera maiuscola (A-Z)",
    numberRequired: "Almeno un numero (0-9)",
    specialCharRequired: "Almeno un carattere speciale (!@#$%^&*)",
    passwordExample: "Esempio",
    chat: 'Chat',
    ...
    businesses: 'Aziende',
    altamediacontent: 'altamedia Contenuto',
  ...
  //   trainingDoesntEnd: 'La Formación No Termina en Clase',
  ...
  //   updateYourPasswordRegularly: "Actualice su contraseña regularmente para mantener la seguridad de la cuenta",
  ...
  //   passwordNotStrongEnough: "La contraseña no es suficientemente fuerte",
  ...
  //   uppercaseRequired: "Al menos una letra mayúscula (A-Z)",
  //   numberRequired: "Al menos un número (0-9)",
  //   specialCharRequired: "Al menos un carácter especial (!@#$%^&*)",
  //   passwordExample: "Ejemplo",



  //   // Additional Spanish translations
  //   businesses: 'Empresas',
  //   altamediacontent: 'altamedia Contenido',
