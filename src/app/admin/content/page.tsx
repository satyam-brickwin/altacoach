...
// Complete translations for table and content management
const adminTranslations = {
  ...
  de: {
    ...
    contentManagementDesc: 'Verwalten und organisieren Sie alle Inhalte für Unternehmen',
    altamediacontent: 'Altamedia Inhalt',
  ...
  it: {
    ...
    altamediaContent: 'Contenuto altamedia',
    actions: 'Azioni',
    view: 'Visualizza',
    download: 'Scarica',
    delete: 'Elimina',
    ...
    addNewContent: 'Aggiungi Nuovo Contenuto',
    contentManagementDesc: 'Gestisci e organizza tutti i contenuti per le aziende',
  ...
  es: {
    ...
    contentManagementDesc: 'Gestionar y organizar todo el contenido para empresas',
